...
ssh -q $VCLI "source /opt/vmware/vma/bin/vifptarget --set $VCENTER;$MOUNTPOINT/bin/vmware-vsphere-cli-distrib/apps/vm/vmcreate_new.pl --filepath '$FILEPATH' --esxihost '$ESXIHOST' --datastore '$DATASTORE' --vmname '$VMNAME'"
if [[ $? -eq 0 ]]
then
