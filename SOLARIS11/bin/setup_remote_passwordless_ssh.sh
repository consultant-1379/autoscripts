...
SCP_COMMAND="scp /.ssh/id_rsa.pub root@${TO_SERVER}:/.ssh/${FROM_SERVER}.key"
CAT_COMMAND="ssh ${TO_SERVER} 'cat /.ssh/${FROM_SERVER}.key >> /.ssh/authorized_keys2;rm /.ssh/${FROM_SERVER}.key'"
